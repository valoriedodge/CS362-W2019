...
void smithy_card(int handPos, int currentPlayer, struct gameState *state){
  //+3 Cards
  int i;
  for (i = 0; i <= 3; i++)
  {
...
void great_hall_card(int handPos, int currentPlayer, struct gameState *state ){
  //+1 Card
  drawCard(currentPlayer, state);
...
void steward_card(int choice1, int choice2, int choice3, int handPos, int currentPlayer, struct gameState *state){
  if (choice1 == 1)
  {
  //+2 cards
  drawCard(currentPlayer, state);
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card )
    {
    case adventurer:
      adventurer_card(z, drawntreasure, handPos, currentPlayer, state, temphand);
      return 0;
    ...
    case smithy:
      smithy_card(handPos, currentPlayer, state);
      return 0;
    ...
    case great_hall:
      great_hall_card(handPos, currentPlayer, state );
      return 0;
    ...
    case steward:
      steward_card(choice1, choice2, choice3, handPos, currentPlayer, state);
      return 0;
