...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card )
    {
    case adventurer:
		return chooseAdventurer(state, handPos);
    ...
    case mine:
	  return chooseMine(state, choice1, choice2, handPos);

    case remodel:
	  return chooseRemodel(state, choice1, choice2, handPos);

    case smithy:
		return chooseSmithy(state, handPos);
    ...
    case baron:
	  return chooseBaron(state, choice1);
